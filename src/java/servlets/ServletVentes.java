...
public class ServletVentes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {  
            ...
            System.out.println("nb de ventes " + lesVentes.size());
        ...
        {  
          ...
          // Récup et affichage de la liste des mails envoyés pour une vente
        ...
        {  
           System.out.println("DANS LISTER LES MAILS");
            ...
            ArrayList<Couriel> lesMails = VenteDAO.getLesMails(connection, idVente);
            request.setAttribute("pLesMails", lesMails);
